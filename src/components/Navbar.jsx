...
function Navbar() {
	...
	return (
		<nav className="bg-white shadow-lg sticky top-0 z-50 py-4 px-8 flex items-center justify-between border-b border-gray-200">
			<div className="flex items-center">
				<img src={logoUrl} alt="IATPL Logo" className="h-16 w-auto mr-8" />
			</div>
